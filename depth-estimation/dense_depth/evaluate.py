...
import os
# Load test data
def load_test_data(path_to_eval_data):
    # print('Loading test data...', end='')
    # def extract_zip(input_zip):
    #     input_zip=ZipFile(input_zip)
    #     return {name: input_zip.read(name) for name in input_zip.namelist()}
    # data = extract_zip(path_to_eval_data)
    
    rgb = np.load(os.path.join(path_to_eval_data,'eigen_test_rgb.npy'))
    depth = np.load(os.path.join(path_to_eval_data,'eigen_test_depth.npy'))
    crop = np.load(os.path.join(path_to_eval_data,'eigen_test_crop.npy'))
